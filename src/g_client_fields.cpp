...
void __cdecl ClientScr_SetSessionTeam(gclient_s *pSelf, client_fields_s *pField)
{
    ...
    else Scr_Error(va("'%s' is an illegal sessionteam string. Must be allies, axis, none, or spectator.", SL_ConvertToString(newTeam)));
...
void __cdecl ClientScr_SetHeadIconTeam(gclient_s *pSelf, client_fields_s *pField)
{
    ...
    else Scr_Error(va("'%s' is an illegal head icon team string. Must be none, allies, axis, or spectator.", SL_ConvertToString(sTeam)));
}
...
void __cdecl ClientScr_SetSessionState(gclient_s *pSelf, client_fields_s *pField)
{
    ...
    else Scr_Error(va("'%s' is an illegal sessionstate string. Must be playing, dead, spectator, or intermission.", SL_ConvertToString(newState)));
}
